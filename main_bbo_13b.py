...
def main():
    ...
    layer_lst = torch.load('./output/llama2_13b_1024_avg32_parameters.pth')
...
# round(s, 4)
    ...
    variables = []
    # for i in range(4):
    x1 = sp.Real(f"qk_ratio", 0.1, 1.001, default_value=ratios[0])
    ...
    ppl = PPLMetric(model, tokenizer, ['wikitext2', 'ptb'], 4096, batch_size=1, device="cuda")
